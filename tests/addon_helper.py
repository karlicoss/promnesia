...
from .webdriver_utils import Driver, get_browser_process, is_headless
...
def _get_chrome_addon_id(driver: Driver) -> str:
    """
...
def _get_firefox_addon_id(driver: Driver) -> str:
...
def get_addon_id(driver: Driver) -> str:
    extractor = {
