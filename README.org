...
- Which hotkeys/shortcuts does Promnesia register in my browser?
  ...
  You can view the shortkey key combinations to press at [chrome://extensions/shortcuts](chrome://extensions/shortcuts) in Chrome and [see here](https://support.mozilla.org/en-US/kb/manage-extension-shortcuts-firefox) for instructions for Firefox.
