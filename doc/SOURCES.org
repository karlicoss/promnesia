...
- [[file:../src/promnesia/sources/viber_desktop.py][promnesia.sources.viber_desktop]]

  Uses the local Viber Desktop SQLite databse in your home directory, 
  usually in =~/.ViberPC/your-tel-number/viber.db=.
