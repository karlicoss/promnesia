This file is an overview of availabe sources along with descriptions and some guidance.

* Dependencies
Some sources require additional dependencies:
...
for (name, description), _ in setup.DEPS_SOURCES.items():
    print(f"- =pip3 install 'promnesia[{name}]'=")
    print(f'   ')
    print(f'   {description}')
#+end_src
